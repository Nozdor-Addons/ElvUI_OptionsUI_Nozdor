...
E.Options.args.search = ACH:Group("|cff00ff00" .. L["Search"] .. "|r", nil, 4)
...
E.Options.args.searchEditBox.order = 1

local Header = {
	order = 1,
	type = "header",
	name = "Пишем что хочем найти в поле слева сверху и кликаем Enter",
	width = "full"
}
local Header2 = {
	order = 2,
	type = "header",
	name = "Результаты будут отображены в развертке вкладки поиск слева",
	width = "full"
}
